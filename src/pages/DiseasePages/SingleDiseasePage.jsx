...
const SingleDiseasePage = (props) => {
  ...
  return (
    <SimpleLayout title={disease?.name}>
      <div className="HomeLayout">
        ...
        <div>
          ...
          <p>
            A graph showing all registered infections of {disease?.name} for the
            period of one year
          </p>
        ...
        <div>
          ...
          <p>
            A table showing overall infections of {disease?.name} for the period
            of one year
          </p>
