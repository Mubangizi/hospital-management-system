...
const HospitalPage = () => {
  ...
  return (
    <SimpleLayout title="Hospitals">
      <div className="HomeLayout ">
        <div>
          <h1>Hospitals Section</h1>
          <p>
            Table showing available hospitals and total number on infections for
        ...
        <div>
          ...
          <p>
            Graphs showing summary of hospital infections for all diseases over
